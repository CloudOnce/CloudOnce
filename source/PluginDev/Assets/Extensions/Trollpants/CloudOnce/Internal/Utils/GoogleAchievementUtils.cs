// <copyright file="GoogleAchievementUtils.cs" company="Trollpants Game Studio AS">
// Copyright (c) 2016 Trollpants Game Studio AS. All rights reserved.
// Licensed under the MIT license. See LICENSE file in the project root for full license information.
// </copyright>

#if UNITY_ANDROID && TP_AndroidGoogle
namespace Trollpants.CloudOnce.Internal.Utils
{
    using System;
    ...
    public class GoogleAchievementUtils : IAchievementUtils
    {
        ...
        public void Unlock(string id, Action<CloudRequestResult<bool>> onComplete, string internalID = "")
        {
            ...
            Action<bool> callback = response => OnReportCompleted(response, onComplete, c_unlockAction, id, internalID);
        ...
        public void Reveal(string id, Action<CloudRequestResult<bool>> onComplete, string internalID = "")
        {
            ...
            Action<bool> callback = response => OnReportCompleted(response, onComplete, c_revealAction, id, internalID);
        ...
        public void Increment(string id, double progress, Action<CloudRequestResult<bool>> onComplete, string internalID = "")
        {
            ...
            Action<bool> callback = response => OnReportCompleted(response, onComplete, c_incrementAction, id, internalID);
